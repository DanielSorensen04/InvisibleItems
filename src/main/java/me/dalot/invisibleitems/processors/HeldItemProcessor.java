package me.dalot.invisibleitems.processors;

import com.comphenix.protocol.events.PacketContainer;
import com.comphenix.protocol.events.PacketEvent;
import com.mojang.datafixers.util.Pair;
import lombok.SneakyThrows;
import me.dalot.invisibleitems.EquipmentPacketProcessor;
import me.dalot.invisibleitems.ItemSlotConverter;
import me.dalot.invisibleitems.NMSHelper;
...
public class HeldItemProcessor extends EquipmentPacketProcessor {

    private Object handSlotEnum = null;
    private Object offhandSlotEnum = null;

    public HeldItemProcessor() {
        try {
